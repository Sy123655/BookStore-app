...
class ir_ui_view(models.Model):
    ...
    def _postprocess_tag_field(self, node, name_manager, node_info):
        try:
            ...
            pass
        return super(ir_ui_view, self)._postprocess_tag_field(node, name_manager, node_info)
    ...
    def _postprocess_tag_button(self, node, name_manager, node_info):
        ...
        # translation_obj = self.env['ir.model.fields']
    ...
    def _postprocess_tag_page(self, node, name_manager, node_info):
        ...
        if page_store_model_nodes_ids:
            for tab in page_store_model_nodes_ids:
                ...
                # if translation_obj._get(None, ('model_terms',), self.env.lang, tab.attribute_string, None) == node.get('string'):
                if node.get('name'):
